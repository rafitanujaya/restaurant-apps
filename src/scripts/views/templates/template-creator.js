  ...
  <div id="resto-item" class="col">
      <div class="card">
          <div class="card-img">
              ...
              <img class="lazyload res-img" src="./images/placeholder.webp" width="100%" height="250"  data-src="${CONFIG.BASE_IMAGE_URL}small/${resto.pictureId}" alt="Restoran ${resto.name}">
          </div>
          <div class="card-body">
              <div class="rating">
